...
export class HelloWorldModel extends Observable {
  ...
  public longpressed(args) {

    console.log(args.item.review);
  }
  ...
  public reviews = [
    { id: 1, image: "~/images/icon-50.png", username: "Moayad Najdawi", review: "this is the first review", rate: 5, datetime: new Date(Date.now() - 24 * 60 * 60 * 1000) },
    { id: 2, image: "~/images/icon-50.png", username: "Demo Nativescript", review: "Thats good", rate: 3, datetime: new Date(Date.now() - 24 * 60 * 60 * 1000) }
  ];
  public lotofreviews = [
